...
function getLocalStorage(){
  try{
    ...
    for(let i = 0; i <noTasks[0];i++){
      let currTask = (0,_taskDOM__WEBPACK_IMPORTED_MODULE_4__.createTask)((0,_task__WEBPACK_IMPORTED_MODULE_0__.task)(taskNames[i],taskDescs[i],taskDeadlines[i],taskPriorities[i],(0,_index__WEBPACK_IMPORTED_MODULE_1__.getTaskID)(),taskStatus[i]));
...
/* harmony export */ });
function task(name,desc,deadline,priority, id,status = false){
...
function createTask(taskObj = (0,_task_js__WEBPACK_IMPORTED_MODULE_0__.task)("","", new Date(),"low",(0,_index_js__WEBPACK_IMPORTED_MODULE_2__.getTaskID)(),false)){
...
function getTask(){
  ...
  return (0,_task_js__WEBPACK_IMPORTED_MODULE_0__.task)(taskName,taskDesc,taskDate,taskPriority,(0,_index_js__WEBPACK_IMPORTED_MODULE_2__.getTaskID)(),false);
}
